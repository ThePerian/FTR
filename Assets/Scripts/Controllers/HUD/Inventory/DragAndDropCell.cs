...
public class DragAndDropCell : MonoBehaviour, IDropHandler
{
    ...
    [Tooltip("Types of items that can be placed in this cell")]
    public List<InventoryItem.ItemType> acceptableItems;                    // Only items of these types can be placed in this cell
